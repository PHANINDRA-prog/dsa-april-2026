...
| 268 | Missing Number | Easy | [Link](https://leetcode.com/problems/missing-number/) | [Code](https://raw.githubusercontent.com/PHANINDRA-prog/dsa-april-2026/main/solutions/Array/10-missing-number.py?raw=true) | May 24, 2026 | simple total sum of n numbers - actual sum will give you the exact number diff missing |
